...
<div class="section" id="user-section">
    <div id="user-detail" style="display: flex; justify-content: space-between; align-items: center;">
        <div class="avatar">
            <img src="assets/img/sample/avatar/avatar1.jpg" alt="avatar" class="imaged w64 rounded">
        </div>
        <div id="user-info">
            <h2 id="user-name">Hana Saharning Kanthi</h2>
            <span id="user-role">Asisten IFLAB</span>
        </div>
        <div id="logout-section" style="margin-left: auto;">
...
<style>
    ...
    .logout-button:hover {
        ...
        border: 2px solid #007bff; /* Warna border saat hover */
    }
</style>
@endsection
